...
import connectors.sources.MimicDirDataSourceFunction;
import data.MimicWaveData;
import org.apache.flink.streaming.connectors.kafka.FlinkKafkaProducer;
import util.UserDefinedWindowFunctions.MovingAverageFunction;
...
public class MimicDataJob {
    public static void main(String[] args) throws Exception {
        ...
        DataStream<MimicWaveData> mimicData = env
                ...
                .assignTimestampsAndWatermarks(new ExtractTimestampMimic());
