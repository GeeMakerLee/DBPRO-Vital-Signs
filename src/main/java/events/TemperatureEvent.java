...
public class TemperatureEvent extends events.MonitoringEvent {
    private double temperature;

    public TemperatureEvent(long ts, int rackID, double temperature) {
        super(ts, rackID);
    ...
    public String toString() {
        ...
        return sdf.format(date) + ",temperature," + getRackID() + "," + temperature;
    }
}
